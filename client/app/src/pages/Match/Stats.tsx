  ...
  useEffect(() => {
    const fetchMatchData = async () => {
      try {
        ...
        const teamStats = await teamStatsService.getById(
          Number(matchey.matchId)
        );
        setTeamStats({
  ...
  useEffect(() => {
    const fetchMatchStats = async () => {
      ...
      try {
        ...
        const goalkeeperRes = await goalkeeperService.getById(
          teamStats?.goalkeeper
        );

        setSummary(summaryRes.data);
        setShoot(shootsRes.data);
        setPasses(passesRes.data);
        setDual(dualsRes.data);
            ...
            <div className="mb-5">
              ...
              <div className="h-2 bg-[#0c1323] rounded-full overflow-hidden">
                <div
                  ...
                  style={{ width: summary?.possession }}
                ></div>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="h-2 bg-[#0c1323] rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width:
                      defense?.tacles_gagnes?.replace("%", "") + "%" || "0%",
                  }}
                ></div>
              </div>
            </div>
              ...
              <div className="mt-4 pt-3 border-t border-[#2a3658]">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-red-500">
                    {defense?.erreurs_menant_a_un_but || 0}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="relative bg-[#1a2138] p-4 rounded-lg border border-[#2a3658] overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-3xl font-bold">
                    {attack?.grosses_occasions_realisees || 0}
                  </p>
                </div>
              ...
              <div className="relative bg-[#1a2138] p-4 rounded-lg border border-[#2a3658] overflow-hidden">
                <div className="relative z-10">
                  ...
                  <p className="text-3xl font-bold">
                    {attack?.grosses_occasions_manquees || 0}
                  </p>
                </div>
            ...
            <div className="bg-[#1a2138] p-4 rounded-lg border border-[#2a3658]">
              ...
              <div className="flex justify-between items-center mt-3">
                <span className="text-gray-400">
                  Tackles Received in Final Third
                </span>
                <span className="text-xl font-bold">
                  {attack?.tacles_recus_dernier_tiers || 0}
                </span>
              </div>
              <div className="flex justify-between items-center mt-3">
                <span className="text-gray-400">Touches in Opponent Box</span>
                <span className="text-xl font-bold">
                  {attack?.touchers_surface_reparation || 0}
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="relative w-32 h-32">
                ...
                <div className="absolute inset-2 rounded-full bg-[#1a2138] flex flex-col items-center justify-center border-4 border-[#2a3658]">
                  <span className="text-4xl font-bold text-blue-400">
                    {goalkeeper?.arrets_du_gardien || 0}
                  </span>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[#1a2138] p-4 rounded-lg border border-[#2a3658]">
                ...
                <p className="text-2xl font-bold">
                  {goalkeeper?.sorties_aeriennes || 0}
                </p>
              </div>
              <div className="bg-[#1a2138] p-4 rounded-lg border border-[#2a3658]">
                <p className="text-xs text-gray-400">Goal Kicks</p>
                <p className="text-2xl font-bold">
                  {goalkeeper?.coup_de_pied_de_but || 0}
                </p>
              </div>
            </div>
          </div>
