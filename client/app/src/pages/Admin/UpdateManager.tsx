...
const UpdateManager = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    axios
      .post("http://127.0.0.1:8000/myapp/user/update/", formData)
      .then((res) => {
    ...
    <>
      <div className="flex justify-center items-center bg-gray-900">
        <form
          ...
          className="my-10 py-11 px-20 sm:px-11 w-full bg-transparent rounded-xl flex flex-col justify-center items-center"
        >
          <h2 className="font-manrope font-bold text-indigo-500 text-3xl border-b border-gray-400 w-full pb-8">
            Update Your Manager Account
          </h2>
          <div className="flex sm:flex-row flex-col justify-between gap-2 mt-8 w-full">
            <div className="flex w-full sm:w-1/2 flex-col jutify-center items-start">
              <label
                htmlFor=""
                className="font-manrope font-semibold text-gray-300"
              >
                Username
              </label>
              <input
          ...
          <div className="mt-4 flex sm:flex-row flex-col justify-between gap-4 w-full">
            <div className="flex w-full sm:w-1/2 flex-col jutify-center items-start">
              ...
              <input
                ...
                className="placeholder:font-medium text-gray-400 outline-none font-manrope font-bold text-md bg-gray-900 my-2 w-full p-2 rounded-lg"
                type="date"
          ...
          <div className="mt-4 flex flex-col justify-center w-full">
            <div className="flex flex-col jutify-center items-start">
              <label
                htmlFor=""
                className="mb-2 font-manrope font-semibold text-gray-300"
              >
                Profile Picture
              </label>
              <PictureInput
                registration={register("profile_picture", { required: true })}
              />
            </div>
